  ...
  obj.bind('markersready', function () {
    ...
    if (obj.vars.behavior.autozoom) {
      if (!obj.bounds.isEmpty()) {
        // Hack from http://drupal.org/node/243985
        ...
        var marginBounds = new GLatLngBounds(new GLatLng(SW.lat() - 0.1*height, SW.lng() - 0.05*width), new GLatLng(NE.lat() + 0.10*height, NE.lng() + 0.05*width) );
